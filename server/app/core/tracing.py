...
def trace_agent(project_name: Optional[str] = None, tags: Optional[list[str]] = None) -> Callable[[F], F]:
    """
    ...
    def decorator(func: F) -> F:
        ...
        def sync_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            traced_func = traceable(
                name=func.__name__,
                project_name=project_name or os.environ.get("LANGCHAIN_PROJECT", "ai-agent-giai-thuat"),
                tags=tags or []
            )(func)
