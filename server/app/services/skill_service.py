...
class SkillService:
    ...
    async def update_skill(self, skill_id: int, skill_data: SkillUpdate) -> Optional[Skill]:
        """
    ...
    async def create_multiple_skills(self, skills_data: List[SkillCreate]) -> List[Skill]:
        """
