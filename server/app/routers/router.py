...
def register_router(app: FastAPI):
    ...
    app.include_router(
        lesson_plan_router.router, prefix="/lesson-plan", tags=["Lesson Plan"]
    )
    app.include_router(
        course_composition_router.router,
        prefix="/course-composition",
        tags=["Course Composition"],
    )
