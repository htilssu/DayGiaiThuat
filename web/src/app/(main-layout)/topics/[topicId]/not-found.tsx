    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16">
            <div className="text-center max-w-md">
                ...
                <h1 className="text-2xl font-bold mb-4">Chủ đề không tồn tại</h1>
                <p className="text-foreground/70 mb-8">
                    Chủ đề bạn đang tìm kiếm không tồn tại hoặc đã bị xóa. Vui lòng kiểm tra lại đường dẫn hoặc quay lại lộ trình học tập.
                </p>
