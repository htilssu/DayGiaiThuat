...
/**
 * Component Footer chứa thông tin liên hệ và điều hướng phụ
 *
    ...
    <footer className="w-full py-16 mt-auto bg-background border-t border-primary/10 transition-theme">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between mb-10">
          <div className="mb-8 md:mb-0 md:max-w-sm">
            <div className="flex items-center gap-2 mb-5">
              <div className="h-8 w-8 bg-gradient-to-br from-primary to-secondary rounded-md flex items-center justify-center text-white font-bold shadow-sm">
            ...
            <p className="text-sm text-foreground/70 mb-4 leading-relaxed">
              Nền tảng học thuật toán và lập trình hàng đầu Việt Nam. Học từ cơ
              bản đến nâng cao với hệ thống bài tập phong phú và tương tác.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Facebook"
                className="text-foreground/50 hover:text-primary transition-colors p-2 rounded-full hover:bg-primary/5">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="text-foreground/50 hover:text-secondary transition-colors p-2 rounded-full hover:bg-secondary/5">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
        ...
        <div className="border-t border-foreground/10 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex text-sm text-foreground/50">
            <Link
